    ...
    <div class="row">
        <div class="col-lg-10 offset-lg-1">
            <div class="card">
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="pull-right">
                            <a href="{{ route('hospitals.index') }}" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="Back to hospitals">
                ...
                <div class="card-body">
                    {!! Form::open(array('route' => 'hospitals.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                {!! Form::text('name', NULL, array('id' => 'name', 'class' => 'form-control', 'placeholder' => 'Enter Hospital Name')) !!}
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('address') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                                {!! Form::textarea('address', NULL, array('id' => 'address', 'class' => 'form-control', 'rows' => 4, 'placeholder' => 'Enter Hospital Address')) !!}
