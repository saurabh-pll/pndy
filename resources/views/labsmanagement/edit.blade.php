...
@section('template_title')
    Editing Diagnostic Lab: {{$lab->name}}
@endsection
            ...
            <div class="card">
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        Editing Diagnostic Diagnostic Lab : {{$lab->name}}
                ...
                <div class="card-body">
                    {!! Form::open(array('route' => ['labs.update', $lab->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('name') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                {!! Form::text('name', $lab->name, array('id' => 'name', 'class' => 'form-control', 'placeholder' => 'Enter Lab Name')) !!}
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('address') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                                {!! Form::textarea('address', $lab->address, array('id' => 'address', 'class' => 'form-control', 'rows' => 4, 'placeholder' => 'Enter Lab Address')) !!}
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('mobile') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                {!! Form::text('mobile', $lab->mobile, array('id' => 'mobile', 'class' => 'form-control', 'placeholder' => 'Enter Lab Mobile Number')) !!}
                    ...
                    <div class="form-group has-feedback row {{ $errors->has('email') ? ' has-error ' : '' }}">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                {!! Form::text('email', $lab->email, array('id' => 'email', 'class' => 'form-control', 'placeholder' => 'Email Address')) !!}
                                <div class="input-group-append">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <select class="custom-select form-control" name="payment_mechanism" id="payment_mechanism">
                                    ...
                                    <option value="Online" {{ $lab->payment_mechanism == "Online" ? 'selected="selected"' : '' }}>Online (NEFT / RTGS)</option>
                                    <option value="UPI" {{ $lab->payment_mechanism == "UPI" ? 'selected="selected"' : '' }}>UPI</option>
                                    <option value="Offline" {{ $lab->payment_mechanism == "Offline" ? 'selected="selected"' : '' }}>Offline(Cheque)</option>
                                </select>
                                <div class="input-group-append">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <select class="custom-select form-control" name="payment_frequency" id="payment_frequency">
                                    ...
                                    <option value="Daily" {{ $lab->payment_frequency == "Daily" ? 'selected="selected"' : '' }}>Daily</option>
                                    <option value="Weekly" {{ $lab->payment_frequency == "Weekly" ? 'selected="selected"' : '' }}>Weekly</option>
                                    <option value="Monthly" {{ $lab->payment_frequency == "Monthly" ? 'selected="selected"' : '' }}>Monthly</option>
                                </select>
                                <div class="input-group-append">
                        ...
                        <table class="table table-responsive table-striped table-sm data-table" id="testTable">
                            ...
                            <tbody id="testBody">
                                @foreach ($lab->tests as $test)
                                    <tr>
                                        <td><input type="checkbox" name="record" class="testSelect"></td>
                                    <td><input type="hidden" name="tests[]" value="{{$test->id}}">{{$test->name}}</td>
                                        <td><input type="hidden" name="price[]" value="{{$test->pivot->price}}">{{$test->pivot->price}}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
